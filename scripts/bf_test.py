...
if __name__ == '__main__':
    template = '/home/omri/catkin_ws/src/armadillo2/armadillo2_demos/elevator/img/button_close.png'
    img = cv2.imread('/home/omri/catkin_ws/src/armadillo2/armadillo2_demos/elevator/img/close3.png')
    ...
    (detected, \
     ...
     button_location, \
     button_height, \
     button_width) = bf.find_match_multi_size(0.5, 2, template, 0.5)

    img_height, img_width = img.shape[:2]

    # pixel_h = img_height - (button_location[1] + button_height / 2)
    # theta = RAD_PER_PXL[1] * pixel_h
    # torso_h1 = 0.42 * math.tan(theta) + 0.17
    # print("\033[1;32;40mtorso_h = {}\033[0m".format(torso_h1))
